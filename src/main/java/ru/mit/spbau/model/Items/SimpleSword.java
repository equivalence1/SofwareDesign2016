 ...
 * Just simple sword
 */
public final class SimpleSword extends Item {

    private final int attack = 5;
    @NotNull private final Buff attackBuff;
    private PlayerUnit playerUnit;

    public SimpleSword(@NotNull Position position) {
        super(position);
        attackBuff = new BuffAttack(attack);
    }

    private SimpleSword(@NotNull SimpleSword sword) {
        super(sword);
